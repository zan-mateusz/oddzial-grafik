...
<h3>Wiersze</h3>
<p>W grafiku piętra widać tylko osoby, które na nim pracują. Wiersz bez wpisów
oznacza kogoś dopisanego ręcznie, kto nie ma jeszcze przydzielonego dyżuru.</p>
"""),

("pietra", "Dwa piętra", """
<h2>Dwa piętra</h2>
<p>Każde piętro ma <b>własny grafik</b>. Pokazuje tylko te osoby, które
faktycznie na nim pracują — dzięki temu przy dużym zespole tabela pozostaje
czytelna. Piętra przełączasz listą <b>Piętro</b> nad tabelą.</p>
...
całości; <b>nie da się w nim wpisywać dyżurów</b>, bo nie byłoby wiadomo,
którego piętra miałyby dotyczyć. Przyciski kodów są wtedy wyszarzone.</p>
<p>Najedź myszką na dyżur, aby zobaczyć, na którym piętrze się odbywa.</p>

<h3>Zabezpieczenie przed podwójnym dyżurem</h3>
<p>W grafiku piętra dyżur odbywany tego dnia na <b>drugim</b> piętrze widać
<b>szarą kursywą</b>. Dzięki temu nie da się nikomu przez pomyłkę wpisać
dwóch dyżurów jednego dnia. Wpisanie czegoś w taką szarą komórkę
<b>przenosi</b> dyżur na oglądane piętro.</p>

<h3>Czyszczenie</h3>
<p>Usunięcie zawartości komórki kasuje dyżur <b>tylko z oglądanego piętra</b>.
Dyżur na drugim piętrze zostaje nietknięty.</p>

<h3>Godziny osoby pracującej na obu piętrach</h3>
<p>Podsumowanie ma osobną kolumnę dla każdego piętra — widać w niej, ile
dyżurów przypadło na które. <b>Wymiar</b>, <b>Bilans</b> i <b>Kwartał</b>
obejmują cały miesiąc niezależnie od piętra, bo pracownik ma jedną umowę
i jeden wymiar czasu pracy.</p>

<h3>Nazwy pięter</h3>
<p>Zmienisz je w <b>Narzędzia → Ustawienia</b>. Tam też dodasz trzecie piętro,
gdyby było potrzebne — w podsumowaniu pojawi się dla niego kolejna kolumna.</p>
"""),
...
<tr><td>nazwa piętra</td><td>dyżury na tym piętrze — jedna kolumna na każde
    piętro; przy jednym piętrze zostaje kolumna <b>Dyżury</b></td></tr>
<tr><td><b>Bilans</b></td><td>nadgodziny albo brakujące godziny w tym
    miesiącu</td></tr>
<tr><td><b>Kwartał</b></td><td>to samo, ale narastająco od początku
    kwartału</td></tr>
...
<h3>Kolory bilansu</h3>
<table>
<tr><th>Kolor</th><th>Znaczenie</th></tr>
<tr><td>czerwony</td><td>godzin brakuje do wymiaru</td></tr>
<tr><td>zielony</td><td>nadgodziny</td></tr>
<tr><td>czarny</td><td>dokładnie tyle, ile trzeba</td></tr>
</table>
...
<p>Grafik piętra pokazuje tylko osoby mające na nim dyżur. Jeśli ktoś ma się
pojawić wcześniej, użyj przycisku <b>Dodaj do grafiku…</b>. Sprawdź też, czy
osoba ma zaznaczone <b>Pracuje obecnie</b> i czy daty zatrudnienia obejmują
ten miesiąc.</p>

<h3>Nie mogę nic wpisać w tabeli</h3>
<p>Prawdopodobnie masz włączony <b>widok łączny</b> (pozycja
<b>Wszystkie piętra</b>). Służy tylko do oglądania — przełącz się na konkretne
piętro, żeby wpisywać dyżury.</p>
